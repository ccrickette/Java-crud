...
public class VehiclesOfInterestController {
    ...
    */  
    ...
    //1111 Arrest Warrant Ford Tauris 2010 Red John Doe 12345
     ...
     */
    {
        try
        {
           ...
           //debug:
            System.out.println("SQL UPDATE: " +  licensePlate +" "+ reason +" "+ make+" "+
             model+" "+ veh_year+" "+ color+" "+ownersName+" "+ownersPhone);
